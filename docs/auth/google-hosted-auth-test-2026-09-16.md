...
- [ ] Dependent merged #1143 merged and rebased; exact-head CI, Prisma validation/migrations, typecheck, lint, tests, build, API and permissions reviewed; one consenting nonprivileged student's preview UAT; root PR template and all #1140 acceptance criteria checked.
