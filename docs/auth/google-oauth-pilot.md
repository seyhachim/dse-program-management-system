...
**Default: OFF; do not enable in production.** This PR is stacked on draft merged #1143. No broad rollout, account auto-provisioning or Student UUID rewrite. Read [the audited approval and recovery runbook](./google-provider-approval.md) before any owner-controlled preview test.
