...
export class TelegramPhase2AccessError extends Error {}
export class TelegramPhase2NotFoundError extends Error {}
...
export const telegramPhase2Service = createTelegramPhase2Service();
