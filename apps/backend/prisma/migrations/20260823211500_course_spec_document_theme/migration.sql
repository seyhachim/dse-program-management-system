...
CREATE TABLE "ProgrammeCourseSpecDocumentTheme" (
  ...
  "bodyFontFamily" TEXT NOT NULL DEFAULT 'Arial',
  "bodyFontSizePt" DOUBLE PRECISION NOT NULL DEFAULT 9,
  "documentTitleSizePt" DOUBLE PRECISION NOT NULL DEFAULT 16,
  "heading1SizePt" DOUBLE PRECISION NOT NULL DEFAULT 15,
  "heading2SizePt" DOUBLE PRECISION NOT NULL DEFAULT 13,
  "heading3SizePt" DOUBLE PRECISION NOT NULL DEFAULT 11,
  "lineHeight" DOUBLE PRECISION NOT NULL DEFAULT 1.3,
  "paragraphSpacingPt" DOUBLE PRECISION NOT NULL DEFAULT 4,
  "letterSpacingPx" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "defaultAlignment" TEXT NOT NULL DEFAULT 'left',
  "marginTopMm" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "marginBottomMm" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "marginLeftMm" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "marginRightMm" DOUBLE PRECISION NOT NULL DEFAULT 10,
  "tableFontSizePt" DOUBLE PRECISION NOT NULL DEFAULT 7.5,
  "tableCellPaddingPt" DOUBLE PRECISION NOT NULL DEFAULT 3,
  "headerFontSizePt" DOUBLE PRECISION NOT NULL DEFAULT 9,
  "footerFontSizePt" DOUBLE PRECISION NOT NULL DEFAULT 7,
