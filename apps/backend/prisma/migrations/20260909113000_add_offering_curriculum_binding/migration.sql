...
-- ProgrammeCurriculumCourse placement that authorized delivery. The placement
-- itself is the canonical link to the curriculum version; no duplicate version
-- id is stored. Historical offerings are not guessed or backfilled.
