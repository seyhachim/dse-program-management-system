-- Issue #133 follow-up: Telegram Mini App replay protection uses a custom
-- PostgreSQL schema introduced after the original database-security baseline.
-- Keep the verification store backend-only and deny direct Supabase Data API
-- access without rewriting the already-applied Telegram migration.
