...
-- `publishedAt` becomes the first-publication provenance timestamp and therefore
-- remains populated while a record is hidden (Draft after unpublish) or Archived.
