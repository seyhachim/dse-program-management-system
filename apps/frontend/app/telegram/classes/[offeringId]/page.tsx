...
export default function TelegramClassPage({ params }: { params: Promise<{ offeringId: string }> }) {
  ...
  if (error) return <section className="space-y-4"><a href="/telegram" className="text-sm text-slate-500">← Home</a><p className="text-sm text-red-700">{error}</p></section>;
