...
export default function ResultAccessSettingsPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      setNotice(required
        ? "Students must complete the final anonymous survey before viewing provisional PMS results."
        : "Students can view published provisional PMS results without completing the survey first.");
    } catch {
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Choose whether students must complete the final anonymous course survey before viewing published provisional results in PMS.
              </p>
            </div>
          </div>
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="rounded-xl border border-border p-4">
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  />
                  <span>
                    <span className="block font-semibold">Require final survey before showing provisional results</span>
                    <span className="mt-1 block text-sm text-muted-foreground">
                      When enabled, only published results that are still provisional are hidden until the student submits the anonymous survey. Finalized and corrected-finalized results remain visible.
                    </span>
                  </span>
                </label>
              </div>
              ...
              <div className="flex gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900 dark:border-emerald-900 dark:bg-emerald-950/30 dark:text-emerald-200">
                ...
                <p>This setting affects only provisional PMS visibility for {selected?.code ?? "this course"}. It does not change marks, finalization, official university submission, or survey anonymity.</p>
              </div>
