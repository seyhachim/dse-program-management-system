    ...
    <div className="h-full px-[62px] py-[30px] font-serif">
      <header className="relative min-h-[128px] text-center">
        <img
          ...
          style={{
            width: `${COURSE_DOCUMENT_STYLE.logo.width}px`,
            height: `${COURSE_DOCUMENT_STYLE.logo.height}px`,
            maxWidth: `${COURSE_DOCUMENT_STYLE.logo.width}px`,
            maxHeight: `${COURSE_DOCUMENT_STYLE.logo.height}px`,
            objectFit: "contain",
            display: "block",
          }}
        />
        ...
        <p className="text-[11px] font-bold leading-[1.15]">
      ...
      <h1 className="mb-4 text-[14px] font-bold uppercase">
