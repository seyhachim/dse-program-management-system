  ...
  return (
    <>
      ...
      <Page zoom={zoom} pageNumber={4}>
        <div id="clos" className="h-full px-[54px] py-[42px]" style={{ display: "block" }}><PartTwoRow>
