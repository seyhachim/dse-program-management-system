export const LECTURER_OVERVIEW_LAYOUT = {
  ...
  summaryGrid: "grid grid-cols-2 gap-2 sm:gap-3 xl:grid-cols-5",
  summaryCard:
    "min-h-20 rounded-[1.35rem] border border-border/70 bg-card p-3 shadow-sm sm:min-h-0 sm:p-4 md:rounded-xl md:border-border",
